...
function AddStudentForm() {
    ...
    return (
        <div className='addStudentform m-5 py-5'>
            <label className="col-form-label">Update admin image:</label>
            ...
            <label className="col-form-label">Update admin first name and last name here:</label>
            ...
            <label className="col-form-label">Update admin cnic here:</label>
            <div className="input-group">
                <input type="text" placeholder='999-99999999-99' aria-label="First name" className="form-control" />
            </div>
            <label className="col-form-label">Update admin email here:</label>
            <div className="input-group">
            ...
            <button type="button" className="btn btn-primary mt-5">Update Admin Profile</button>
